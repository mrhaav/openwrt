# Fibocom FM350-GL firmware upgrade to 29.23.06
...
- Copy folder `81600.0000.00.29.23.06` to a known location
- Copy folder `download_agent` to your `81600.0000.00.29.23.06` folder
...
- Copy all files in folder `FM350.F09` to your `81600.0000.00.29.23.06` folder
- Open folder `FM350.F09_preloader`
